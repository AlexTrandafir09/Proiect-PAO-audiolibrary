...
public class UsersDatabase {
    ...
    public static void insert(User user) {
        ...
        try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/PAO-PROIECT", "user", "1234")) {
            ...
            String insertIntoStatement = "INSERT INTO users (username, password, role) VALUES (?, ?, ?)";
        ...
        try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/PAO-PROIECT", "user", "1234")) {
            ...
            try (Statement statement = connection.createStatement();
                ...
                while (resultSet.next()) {
                    ...
                    User user= User.builder().id(id).user(username).password(password).role(Roles.valueOf(role)).build();
                    userList.add(user);
                }
            }
        } catch (SQLException e) {
